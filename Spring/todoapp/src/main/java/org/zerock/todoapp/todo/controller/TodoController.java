package org.zerock.todoapp.todo.controller;
...
import org.zerock.todoapp.todo.service.TodoService;
...
//    }
    ...
    @GetMapping({ "/edit"})
    public String edit(Long tno,PageRequestDTO pageRequestDTO,
                     Model model,
                     HttpSession session,
                     RedirectAttributes redirectAttributes){
        TodoDTO dto = todoService.getOne(tno);
        if(session.getAttribute("UserId") == null || !session.getAttribute("UserId").toString().equals(dto.getWriter())){
    ...
    public String register(TodoDTO todoDTO, HttpSession session){
    ...
    public String editPost(TodoDTO todoDTO,
        ...
        if(session.getAttribute("UserId") == null || !session.getAttribute("UserId").toString().equals(todoDTO.getWriter())){
            redirectAttributes.addFlashAttribute("msg", "권한이 없습니다.");
